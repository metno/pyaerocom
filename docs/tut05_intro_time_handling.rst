...
.. parsed-literal::
    ...
    /home/jonasg/anaconda3/lib/python3.6/site-packages/iris/fileformats/_pyke_rules/compiled_krb/fc_rules_cf_fc.py:1808: UserWarning: Ignoring netCDF variable 'od550aer' invalid units '~'
      warnings.warn(msg)
    2018-09-25 10:53:21,521:WARNING:
...
.. parsed-literal::
    ...
    140 ms ± 19.5 ms per loop (mean ± std. dev. of 7 runs, 10 loops each)
...
.. parsed-literal::
    ...
    198 ms ± 16.9 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    263 ms ± 21.9 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    180 ms ± 31 ms per loop (mean ± std. dev. of 7 runs, 10 loops each)
...
.. parsed-literal::
    ...
    2.17 ms ± 158 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
.. parsed-literal::
    ...
    61.5 µs ± 772 ns per loop (mean ± std. dev. of 7 runs, 10000 loops each)
...
.. parsed-literal::
    ...
    422 µs ± 8.47 µs per loop (mean ± std. dev. of 7 runs, 1000 loops each)
...
.. parsed-literal::
    ...
    2.63 ms ± 48.4 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
.. parsed-literal::
    ...
    484 µs ± 8.01 µs per loop (mean ± std. dev. of 7 runs, 1000 loops each)
...
.. parsed-literal::
    ...
    2.71 ms ± 68.3 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
