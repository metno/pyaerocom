...
.. parsed-literal::
    ...
    2018-09-07 17:43:51,246:INFO:
    Reading aliases ini file: /home/jonasg/github/pyaerocom/pyaerocom/data/aliases.ini


.. parsed-literal::

    Elapsed time init all variables: 0.027642011642456055 s


.. parsed-literal::

    2018-09-07 17:43:52,133:WARNING:
    geopy library is not available. Aeolus data read not enabled


.. parsed-literal::

    Elapsed time init pyaerocom: 0.9664804935455322 s
...
.. parsed-literal::
    ...
    /home/jonasg/anaconda3/lib/python3.6/site-packages/iris/fileformats/_pyke_rules/compiled_krb/fc_rules_cf_fc.py:1808: UserWarning: Ignoring netCDF variable 'od550oa' invalid units '~'
      warnings.warn(msg)
    2018-09-07 17:43:52,329:WARNING:
...
.. parsed-literal::
    ...
    126 ms ± 8.36 ms per loop (mean ± std. dev. of 7 runs, 10 loops each)
...
.. parsed-literal::
    ...
    124 ms ± 11.1 ms per loop (mean ± std. dev. of 7 runs, 10 loops each)
...
.. parsed-literal::
    ...
    186 ms ± 43.7 ms per loop (mean ± std. dev. of 7 runs, 10 loops each)
...
.. parsed-literal::
    ...
    144 ms ± 25 ms per loop (mean ± std. dev. of 7 runs, 1 loop each)
...
.. parsed-literal::
    ...
    64.3 µs ± 4.62 µs per loop (mean ± std. dev. of 7 runs, 10000 loops each)
...
.. parsed-literal::
    ...
    384 µs ± 15.8 µs per loop (mean ± std. dev. of 7 runs, 1000 loops each)
...
.. parsed-literal::
    ...
    2.81 ms ± 380 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
...
.. parsed-literal::
    ...
    406 µs ± 9.75 µs per loop (mean ± std. dev. of 7 runs, 1000 loops each)
...
.. parsed-literal::
    ...
    2.6 ms ± 347 µs per loop (mean ± std. dev. of 7 runs, 100 loops each)
