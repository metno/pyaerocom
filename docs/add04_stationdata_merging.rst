...
AEROCOM naming convention) for the station ***Jungfraujoch***, located
in Germany.
...
.. parsed-literal::
    ...
    Filters that were applied:
     Filter time log: 20190206180229
    	datalevel: 2
...
.. parsed-literal::
    ...
    OrderedDict([('station_name', 'Jungfraujoch'),
...
.. parsed-literal::
    ...
    ---------------------
    var_info ({'scatc550aer': {'name': 'aerosol_light_scattering_coefficient', 'unit': '1/Mm', 'wavelength': '550.0 nm', 'method_ref': 'CH02L_scat_coef', 'matrix': 'aerosol', 'statistics': 'arithmetic mean', 'overlap': False}})
    ...
    dtime (array, 8760 items)
       [numpy.datetime64('1995-01-01T00:30:00')
        numpy.datetime64('1995-01-01T01:29:59')
        ...
        numpy.datetime64('1995-12-31T22:29:59')
        numpy.datetime64('1995-12-31T23:29:59')]
...
.. parsed-literal::
    ...
    Pyaerocom StationData
    ---------------------
    var_info ({'scatc550aer': {'name': 'aerosol_light_scattering_coefficient', 'unit': '1/Mm', 'wavelength': '525.0 nm', 'statistics': 'arithmetic mean', 'matrix': 'aerosol', 'overlap': False}})
       scatc550aer (<class 'dict'>)
        name: aerosol_light_scattering_coefficient
        unit: 1/Mm
        wavelength: 525.0 nm
    ...
    .................
    dtime (array, 8760 items)
       [numpy.datetime64('2017-01-01T00:30:00')
        numpy.datetime64('2017-01-01T01:29:59')
        ...
        numpy.datetime64('2017-12-31T22:29:59')
        numpy.datetime64('2017-12-31T23:29:59')]
...
.. code:: ipython3
    ...
    first_file.plot_variable('scatc550aer')
...
.. parsed-literal::
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7fef7c4050f0>




.. image:: add04_stationdata_merging/add04_stationdata_merging_11_1.png


.. code:: ipython3

    last_file.plot_variable('scatc550aer')
...
.. parsed-literal::
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7fef7c33f550>




.. image:: add04_stationdata_merging/add04_stationdata_merging_12_1.png
...
.. parsed-literal::
    ...
    Pyaerocom StationData
    ---------------------
    var_info ({'scatc550aer': {'name': 'aerosol_light_scattering_coefficient', 'unit': '1/Mm', 'wavelength': '550.0 nm;525.0 nm', 'method_ref': 'CH02L_scat_coef', 'matrix': 'aerosol', 'statistics': 'arithmetic mean', 'overlap': False}})
       scatc550aer (<class 'dict'>)
        name: aerosol_light_scattering_coefficient
        unit: 1/Mm
...
.. code:: ipython3
    ...
    merged.plot_variable('scatc550aer')
...
.. parsed-literal::
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7fef7bea3ef0>




.. image:: add04_stationdata_merging/add04_stationdata_merging_17_1.png
...
.. parsed-literal::
    ...
    Pyaerocom StationData
    ---------------------
    var_info ({'scatc550aer': {'name': 'aerosol_light_scattering_coefficient', 'unit': '1/Mm', 'wavelength': '550.0 nm;525.0 nm', 'statistics': 'arithmetic mean', 'matrix': 'aerosol', 'overlap': False, 'method_ref': 'CH02L_scat_coef', 'ts_type': 'hourly'}})
       scatc550aer (<class 'dict'>)
        name: aerosol_light_scattering_coefficient
        unit: 1/Mm
        wavelength: 550.0 nm;525.0 nm
    ...
    .................
    dtime (array, 8760 items)
       [numpy.datetime64('2001-01-01T00:30:00')
        numpy.datetime64('2001-01-01T01:29:59')
        ...
        numpy.datetime64('2001-12-31T22:29:59')
        numpy.datetime64('2001-12-31T23:29:59')]
...
.. code:: ipython3
    ...
    ax = merged.plot_variable('scatc550aer')
    merged.plot_variable('scatc550aer', freq='daily', ax=ax)
    merged.plot_variable('scatc550aer', freq='monthly', lw=3, ax=ax)
    merged.plot_variable('scatc550aer', freq='yearly', ls='none', marker='o', ms=10, ax=ax)
...
.. parsed-literal::
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7fef7c13a0b8>




.. image:: add04_stationdata_merging/add04_stationdata_merging_23_1.png
...
.. code:: ipython3
    ...
    data.to_station_data('Jungfraujoch', 'scatc550aer').plot_variable('scatc550aer')
...
.. parsed-literal::
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7fef7c2688d0>
...
.. code:: ipython3
    ...
    merged.plot_variable('scatc550aer', add_overlaps=True)
...
.. parsed-literal::
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7fef7c52b780>




.. image:: add04_stationdata_merging/add04_stationdata_merging_30_1.png
...
.. code:: ipython3
    ...
    merged_pref_recent_revision.plot_variable('scatc550aer', add_overlaps=True)
...
.. parsed-literal::
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7fef7c228c50>
...
.. parsed-literal::
    ...
    <matplotlib.legend.Legend at 0x7fef7c2d7048>




.. image:: add04_stationdata_merging/add04_stationdata_merging_39_1.png
