...
from pyaerocom.units.molecularmass import get_mmr_to_vmr_fac, get_molmass
...
def _apply_operator_cubes(cube1, cube2, operator_name, allow_coord_merge=True):
    ...
    try:
        ...
        if "differing coordinates (time)" in repr(e):
            ...
            copy_coords_cube(to_cube=cube2, from_cube=cube1, inplace=True)
    return fun(cube1, cube2)
...
def add_cubes(cube1, cube2):
    ...
    cube_out = _apply_operator_cubes(cube1, cube2, "add", allow_coord_merge=True)
...
def subtract_cubes(cube1, cube2):
    ...
    cube_out = _apply_operator_cubes(cube1, cube2, "subtract", allow_coord_merge=True)
...
def multiply_cubes(cube1, cube2):
    ...
    cube1, cube2 = _check_input_iscube(cube1, cube2)
    cube_out = _apply_operator_cubes(cube1, cube2, "multiply", allow_coord_merge=True)
...
def divide_cubes(cube1, cube2):
    ...
    cube1, cube2 = _check_input_iscube(cube1, cube2)
    cube_out = _apply_operator_cubes(cube1, cube2, "divide", allow_coord_merge=True)
