...
def test_load_berlin_AeroSdaV2L2D():
    ...
    npt.assert_allclose(vals, [[0.032407, 0.032407], 
                               [0.1478702438271605, 0.1478702438271605], 
                               [0.18027727777777777, 0.18027727777777777], 
                               [1.370816135802469, 1.370816135802469], 
                               [0.15816649236826943, 0.15816649236826943], 
                               [0.028642200727959588, 0.028642200727959588], 
                               [0.12952426131370623, 0.12952426131370623]], 
                        rtol=TEST_RTOL)
