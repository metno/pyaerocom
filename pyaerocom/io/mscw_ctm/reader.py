...
class ReadMscwCtm(GriddedReader):
    ...
    AUX_REQUIRES = {
        ...
        "fractioneBCbb": ["concecTotalRes", "concebc"],
        "fractioneBCff": ["concecTotalNonRes", "concebc"],
        ...
        "fractioneBCbbEM": ["concecTotalResEM", "concecFineEM"],
        "fractioneBCffEM": ["concecTotalNonResEM", "concecFineEM"],
    ...
    AUX_FUNS = {
        ...
        "fractioneBCbb": calc_ebcfraction,
        "fractioneBCff": calc_ebcfraction,
        # For EC from emission
        "concecTotalResEM": add_dataarrays,
        "concecTotalNonResEM": add_dataarrays,
        "concebcem": identity,
        "fractioneBCbbEM": calc_ebcfraction,
        "fractioneBCffEM": calc_ebcfraction,
