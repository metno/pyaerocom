...
_HTAP_DEFS = {
    'PAN': {'lat_range': [-54.74999999999966, 11.550000000000823],
            'lon_range': [-134,112]},
    'EAS': {'lat_range': [18.25000000000084, 53.55000000000134],
            'lon_range': [73.64999999999412, 145.74999999999002]},
    'NAF': {'lat_range': [19.05000000000085, 37.25000000000111],
            'lon_range': [-17.050000000005937, 35.74999999999427]},
    'MDE': {'lat_range': [12.150000000000821, 39.65000000000114],
            'lon_range': [34.24999999999425, 63.249999999994664]},
    'LAND': {'lat_range': [-59.449999999999726, 71.15000000000109],
             'lon_range': [-180, 180]},
    'SAS': {'lat_range': [-9.749999999999135, 37.050000000001106],
            'lon_range': [46.349999999994424, 97.34999999999278]},
    'SPO': {'lat_range': [-89.94999999999831, -60.049999999999734],
            'lon_range': [-179.95000000000002, 179.94999999998808]},
    'OCN': {'lat_range': [-59.94999999999973, 66.25000000000136],
            'lon_range': [-180, 180]},
    'SEA': {'lat_range': [-11.649999999999128, 28.450000000000983],
            'lon_range': [92.24999999999307, 155.94999999998944]},
    'RBU': {'lat_range': [29.450000000000998, 66.25000000000136],
            'lon_range': [-170, 22]},
    'EEUROPE': {'lat_range': [34.65000000000107, 59.550000000001425],
                'lon_range': [12.14999999999401, 44.7499999999944]},
    'NAM': {'lat_range': [18.95000000000085, 71.15000000000109],
            'lon_range': [-52, 172]},
    'WEUROPE': {'lat_range': [27.750000000000973, 66.45000000000135],
                'lon_range': [-31.25000000000614, 31.449999999994215]},
    'SAF': {'lat_range': [-54.449999999999655, 27.250000000000966],
            'lon_range': [-25.350000000006055, 77.5499999999939]},
    'USA': {'lat_range': [18.95000000000085, 49.35000000000128],
            'lon_range': [-159.75000000000117, -56.250000000006494]},
    'SAM': {'lat_range': [-59.449999999999726, 5.150000000000846],
            'lon_range': [-109.35000000000403, -26.250000000006068]},
    'EUR': {'lat_range': [27.750000000000973, 66.45000000000135],
            'lon_range': [-31.25000000000614, 44.7499999999944]},
    'NPO': {'lat_range': [59.85000000000143, 89.95000000000002],
            'lon_range': [-179.95000000000002, 179.94999999998808]},
    'MCA': {'lat_range': [-4.149999999999155, 32.65000000000104],
