...
# =============================================================================
    ...
    dataset_ref = ';'.join(ungridded_data.contains_datasets)
...
if __name__=='__main__':
    ...
    obsdata = pya.io.ReadUngridded().read(
        
        ['GHOST.hourly', 'GHOST.daily'], 'conco3', only_cached=True)
    
    stat = obsdata.to_station_data('Bleak House', 'conco3')
