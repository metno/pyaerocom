...
var_ranges_defaults = {
    ...
    "concecff": {"scale": [0, 1.25, 2.5, 3.75, 5, 6.25, 7.5, 8.75, 10], "colmap": "coolwarm"},
    "concecbb": {"scale": [0, 1.25, 2.5, 3.75, 5, 6.25, 7.5, 8.75, 10], "colmap": "coolwarm"},
    "concebc": {"scale": [0, 1.25, 2.5, 3.75, 5, 6.25, 7.5, 8.75, 10], "colmap": "coolwarm"},
    "ebcfrac": {"scale": [0, 0.1, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875, 1], "colmap": "coolwarm"},
    "conclevoglucosan": {
...
var_web_info = dict(
    ...
    concecff=["eECff", "3D", "Particle concentration"],
    concecbb=["eECbb", "3D", "Particle concentration"],
    concebc=["EBC", "3D", "Particle concentration"],
    ebcfrac=["eECbb/EBC", "3D", "Fraction"],
    ...
    concCecpm25=["EC_PM2.5", "3D", "Particle concentration"],
    concCocpm25=["OC_PM2.5", "3D", "Particle concentration"],
    concCecpm10=["EC_PM10", "3D", "Particle concentration"],
    concCocpm10=["OC_PM10", "3D", "Particle concentration"],
    concCecFine=["EC_Fine", "3D", "Particle concentration"],
    concCocFine=["OC_Fine", "3D", "Particle concentration"],
    concCecCoarse=["EC_Coarse", "3D", "Particle concentration"],
    concCocCoarse=["OC_Coarse", "3D", "Particle concentration"],
