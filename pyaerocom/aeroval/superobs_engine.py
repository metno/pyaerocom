...
class SuperObsEngine(ProcessingEngine, HasColocator):
    ...
    """
    def run(self, model_name, obs_name, var_list, 
    ...
    def _process_entry(self, model_name, obs_name, var_list,
    ...
    def _run_var(self, model_name, obs_name, var_name,
                 try_colocate_if_missing):
        """
