...
#: tarfile to download
DEFAULT_TESTDATA_FILE = "testdata-minimal.tar.gz.20241129"
...
minimal_dataset = pooch.create(
    ...
    registry={
        ...
        "testdata-minimal.tar.gz.20241126": "md5:0f402171285c0e1bec1abc610d049fba",
        "testdata-minimal.tar.gz.20241129": "md5:953a1bac278e3f5ef1fc39c5ec17e8eb",
    },
)
