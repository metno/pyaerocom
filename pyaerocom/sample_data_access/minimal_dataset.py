...
#: tarfile to download
DEFAULT_TESTDATA_FILE = "testdata-minimal.tar.gz.20250508"
...
minimal_dataset = pooch.create(
    ...
    registry={
        ...
        "testdata-minimal.tar.gz.20250508": "md5:3d3ac583d3bda79f15286408fb803dc8",
        "testdata-minimal.tar.gz.20250507v2": "md5:62f6e37723973a0e2a0a9de6f02b58bc",
    },
)
