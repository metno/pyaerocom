...
def collocate_gridded_ungridded_3D(gridded_data, ungridded_data, ts_type='daily', 
                                   start=None, stop=None, 
                                   filter_name='WORLD-wMOUNTAINS',
                                   var_ref=None):
    """Collocate 3D gridded with ungridded data  
    
    3D means, that the vertical direction is sampled at more than one altitude or
