...
@pytest.mark.parametrize(
    ...
    [
        ...
        (dict(df=make_dataframe(), norm_ref=0.1, normalise_rows=True), does_not_raise_exception()),
        (
            dict(df=make_dataframe(), normalise_rows=True, normalise_rows_how="mean"),
            does_not_raise_exception(),
        ),
        (
            dict(df=make_dataframe(), normalise_rows=True, normalise_rows_how="median"),
            does_not_raise_exception(),
        ),
        (
            dict(df=make_dataframe(), normalise_rows=True, normalise_rows_how="median"),
        ...
        (
            dict(df=make_dataframe(), normalise_rows=True, normalise_rows_how="sum"),
            pytest.raises(ValueError),
        ),
        (
            dict(df=make_dataframe(), normalise_rows=True, normalise_rows_how="BLAA"),
            pytest.raises(ValueError),
        ),
        (
            dict(df=make_dataframe(), normalise_rows=True, normalise_rows_col="BLAAA"),
            pytest.raises(ValueError),
        ),
        (
            dict(df=make_dataframe(), normalise_rows=True, normalise_rows_col="M3"),
            does_not_raise_exception(),
        ),
        (dict(df=make_dataframe(), color_rowwise=True), does_not_raise_exception()),
        (
            dict(
                df=make_dataframe(),
        ...
        (dict(df=make_dataframe(), annot=None), does_not_raise_exception()),
        (dict(df=make_dataframe(), annot=strannot), does_not_raise_exception()),
        (dict(df=make_dataframe(), annot_fmt_rowwise=True), does_not_raise_exception()),
        (
        ...
        (
            dict(df=make_dataframe(), annot_fmt_rowwise=True, annot_fmt_exceed=[2, ".1E"]),
            does_not_raise_exception(),
        ),
        (
        ...
        (dict(df=make_dataframe(), cbar_labelsize=12), does_not_raise_exception()),
        (
            dict(
                df=make_dataframe(), annot_fmt_rowwise=True, annot=make_dataframe().values * 1e-6
            ),
            does_not_raise_exception(),
        ),
        (
            dict(
                df=make_dataframe(), annot_fmt_rowwise=True, annot=make_dataframe().values * 1e-2
            ),
            does_not_raise_exception(),
        ),
        (
            dict(df=make_dataframe(), annot_fmt_rowwise=True, annot=make_dataframe().values * 1e6),
            does_not_raise_exception(),
        ),
    ],
)
