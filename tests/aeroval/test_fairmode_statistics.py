...
def fairmode_statistics(patched_config):
    ...
    # assert isinstance(fairmode_statistics, ProcessingEngine)
    # assert isinstance(fairmode_statistics, HasColocator)
...
# @pytest.fixture
# def fairmode_coldata(tmp_path) -> tuple[FairmodeStatistics, ColocatedData, Colocator]:
#    model_name = "EMEP"
#    obs_name = "testdata-d"
#    cfg = fairmode_cfg(tmp_path)
#    setup = EvalSetup(**cfg)

#    engine = FairmodeStatistics(setup)
...
#    assert isinstance(engine, FairmodeStatistics)
