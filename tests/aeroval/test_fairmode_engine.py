...
@pytest.fixture
def dummy_coldata_to_fairmode_engine():
...
def test_fairmode_statistics(fairmode_engine, dummy_coldata_to_fairmode_engine):
    fm_stats = fairmode_engine.fairmode_statistics(dummy_coldata_to_fairmode_engine, "concno2")
