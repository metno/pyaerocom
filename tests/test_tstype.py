...
@pytest.mark.parametrize(
    "ts_type, to_ts_type, min_num_obs, val, raises",
    [
...
@pytest.mark.parametrize(
    "ts_type, total_seconds, value, raises",
    [
