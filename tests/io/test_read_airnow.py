...
class TestReadAirNow:
    ...
    def test__read_files_single_var(
        self, reader, vars_to_retrieve, statnum, first_dtime, first_vals, unit, expectation
    ):
    ...
    def test_read(self, reader, vars_to_retrieve, num_meta_blocks, num_stats):
