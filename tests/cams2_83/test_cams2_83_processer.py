...
@lustre_avail
@pytest.mark.usefixtures("fake_CAMS2_83_Engine")  # , "fake_Colocator")
def test__run_single_entry(patched_config, tmp_path):
    ...
    d1 = (
        tmp_path
        / "cams2-83/prototype/CAMS2-83-EMEP-day1-FC/concno2_concno2_MOD-CAMS2-83-EMEP-day1-FC_REF-EEA-UTD_20250301_20250301_hourly_ALL-wMOUNTAINS.nc"
    )
    d2 = (
        tmp_path
        / "cams2-83/prototype/CAMS2-83-EMEP-day2-FC/concno2_concno2_MOD-CAMS2-83-EMEP-day2-FC_REF-EEA-UTD_20250301_20250301_hourly_ALL-wMOUNTAINS.nc"
    )
    d3 = (
        tmp_path
        / "cams2-83/prototype/CAMS2-83-EMEP-day3-FC/concno2_concno2_MOD-CAMS2-83-EMEP-day3-FC_REF-EEA-UTD_20250301_20250301_hourly_ALL-wMOUNTAINS.nc"
    )
    dp = (
        tmp_path
