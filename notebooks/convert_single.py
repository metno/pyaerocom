...
if __name__=="__main__":
    ...
    parser.add_argument('file', type=str,
                        help=("filename"))
    parser.add_argument('--execute', '-exec', type=bool, default=True,
                        help=("Boolean: execute notebook before conversion " 
                              "to rst format"))
    ...
    if args.clear_old:
        matches = fnmatch.filter(os.listdir(out_dir), file)
    ...
    if args.execute:
        execute_and_save_notebook(file)
    ...
    try:
        ...
        print("Failed to convert {} (Error: {})".format(name))
