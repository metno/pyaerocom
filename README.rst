...
Note - You are a development branch
=============================================

This is a development branch of pyaerocom. It is usually ahead of `master <https://github.com/metno/pyaerocom/tree/master>`__ and the `latest release <https://anaconda.org/conda-forge/pyaerocom>`__, and will have to be installed manually. We recommend using this branch only after double-checking with the developers.
